...
contract PortalAdapter is ILiquidityLayerAdapter, Router {
  ...
  function completeTransfer(bytes memory encodedVm) public {
    ...
    IPortalTokenBridge.TransferWithPayload memory _transfer = portalTokenBridge
      .parseTransferWithPayload(_tokenBridgeTransferWithPayload);
    ...
    portalTransfersProcessed[transferId(_originDomain, _nonce)] = tokenAddress;
  }
